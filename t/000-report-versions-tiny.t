...
eval { $v .= pmver('Math::Round','any version') };
eval { $v .= pmver('Module::Pluggable','3.1') };
eval { $v .= pmver('PDL','2.004') };
eval { $v .= pmver('PDL::Core::Dev','any version') };
eval { $v .= pmver('PDL::Lite','any version') };
eval { $v .= pmver('PDL::Types','any version') };
